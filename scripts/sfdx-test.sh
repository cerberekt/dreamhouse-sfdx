...
sfdx force:auth:jwt:grant --clientid $CI_SFDX_CONSUMER_KEY --jwtkeyfile "$CI_PROJECT_DIR/assets/server.key" --username $CI_SFDX_USERNAME --setdefaultdevhubusername -a HubOrg
